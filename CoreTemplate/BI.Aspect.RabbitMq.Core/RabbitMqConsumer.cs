...
namespace BI.Aspect.RabbitMq
{
	...
	public class RabbitMqConsumer : IDisposable
	{
	    ...
	    ///
	    /// </summary>
	    // TODO public RabbitMqConsumer() => this._settings = RabbitMqConfigSettings.Instance.GetSettingsValues();
	    public RabbitMqConsumer(Core.RabbitMqSettingsValues settings)
	    {
	        this._settings = settings;
            // TODO How to distribute the settings without a major refactor? It would be dependency injection if it wasn't static.
	        RabbitMqMessage._settings = settings;
	    }
