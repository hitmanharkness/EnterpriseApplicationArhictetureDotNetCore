...
namespace BI.Aspect.RabbitMq
{
    ...
    internal class RabbitMqSettingsValues
    {
    ...
    public class RabbitMqConsumer : IDisposable
    {
        ...
        public RabbitMqConsumer() => this._settings = new RabbitMqSettingsValues();
        ...
        private void StartThreads()
        {
            ...
            for (var i = 0; i < this._settings.MaxChannels; i++)
                Task.Run(() =>
                {
                    ...
                    new RabbitMqThread(this._cnx, token)
                    {
    ...
    internal class RabbitMqThread
    {
        ...
        internal RabbitMqThread(IConnection cnx, CancellationToken token)
        {
            this._cnx = cnx;
        ...
        internal void StartConsuming()
        {
            ...
            this._channel.DeclareExchangeAndQueue(null);
