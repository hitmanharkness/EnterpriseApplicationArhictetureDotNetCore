...
namespace BI.Aspect.Config
{
	...
	///
	/// </summary>
	public class ConfigSettingsRabbitMq : ConfigurationSection
	{
		...
		///
		/// </summary>
		public static readonly Lazy<ConfigSettingsRabbitMq> Lazy = new Lazy<ConfigSettingsRabbitMq>(GetConfigSettings);

		/// <summary>
		///
		/// </summary>
		public static ConfigSettingsRabbitMq Instance => Lazy.Value;

		private static ConfigSettingsRabbitMq GetConfigSettings()
		{
			var configSection = (ConfigSettingsRabbitMq)ConfigurationManager.GetSection(SECTION_NAME);
		...
		//NOTE: The properties at the root lavel are meant to be used by consumers or the mass transit implementation.
	...
	public class RabbitMqConfigCollection : ConfigurationElementCollection
	{
		...
		{
			get { return (RabbitMqConfigElement)base.BaseGet(index); }
			set
			{
		...
		public void Add(ConfigSettingsRabbitMq element)
		{
		...
		{
			return new RabbitMqConfigElement();
		}
		...
		{
			return ((RabbitMqConfigElement)element).AppName;
		}
	...
	public class RabbitMqConfigElement : ConfigurationElement
	{
		...
		///
		/// </summary>
		[ConfigurationProperty(SettingsConstants.REPLY_TIMEOUT, IsRequired = false, DefaultValue = 10000)]
		public int ReplyTimeout => (int)this[SettingsConstants.REPLY_TIMEOUT];
