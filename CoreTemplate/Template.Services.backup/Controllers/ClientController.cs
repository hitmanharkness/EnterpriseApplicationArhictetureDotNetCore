    ...
    public class ClientController : ServicesControllerBase
    {
        ...
        public IActionResult GetClientEvents(int id)
        {
            ...
            try
            {
                ...
                //return new OkObjectResult(_clientManager.GetClientEvents(123));
